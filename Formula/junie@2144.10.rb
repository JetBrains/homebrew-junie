class JunieAT214410 < Formula
  desc "Junie CLI"
  homepage "https://www.jetbrains.com/junie"
  url "https://github.com/JetBrains/junie/releases/download/2144.10/junie-release-2144.10-macos-aarch64.zip"
  sha256 "f4baf2162bdd70a1c132c486da4fc6772d5fdf31f32d9b06125c7a6d8cd35676"
  version "2144.10"
...
SHIM_EOF
  ...
  def shim_script
    <<~'SHIM'
      ...
      # Known update channels. Keep in sync with templates/channels.tsv in the
      # JetBrains/junie repo, which hosts the per-channel installers this shim calls.
